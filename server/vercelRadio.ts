...
const modeDirections = {
  ...
  "과몰입 새벽":
    "아주 평범한 일상도 재미있게 크게 받아들이는 심야 라디오 DJ처럼 이야기하세요. 사소한 상황을 살짝 과장하거나 진지한 척 풀어내는 유머를 사용할 수 있습니다. 다만 시적이거나 문학적인 표현, 거창한 비유, 철학적인 표현은 사용하지 마세요. 웃기지만 부담스럽지 않고, 실제 DJ가 장난스럽게 이야기하는 느낌을 유지하세요.",
